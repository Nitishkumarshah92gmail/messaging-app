  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    if (isSignUp) {
      ...
      if (error) {
        ...
        setError('Success! Please check your email for a confirmation link, or log in if email confirmation is disabled.');
        setIsSignUp(false);
      }
    } else {
      // Sign In
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-950 text-white p-4">
      <div className="max-w-md w-full bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-xl">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-2 tracking-tight">Scholars Chat Pro</h1>
        ...
        {error && (
          <div className={`p-3 rounded-lg text-sm mb-6 border ${
        ...
        <button
          ...
          className="mt-6 w-full bg-white text-gray-900 hover:bg-gray-100 font-medium py-3 rounded-lg transition-colors flex items-center justify-center gap-2"
        >
